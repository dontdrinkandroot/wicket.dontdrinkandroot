 ...
 */
package net.dontdrinkandroot.extension.wicket.component.jqueryui;

import net.dontdrinkandroot.extension.wicket.jqueryui.JQueryUiScript;
...
public class JqueryUiProgressBar extends GenericWebMarkupContainer<Integer>
{
    ...
    public void renderHead(IHeaderResponse response)
    {
        ...
        response.render(OnDomReadyHeaderItem.forScript(new JQueryUiScript(this).progressBar(this.getModelObject())
                .toString()));
    }
