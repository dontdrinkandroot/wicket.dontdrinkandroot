package net.dontdrinkandroot.extension.wicket.bootstrap.panel;
...
abstract public class EditableActionPanel<T> extends PlainActionPanel<T>
{
    ...
    public EditableActionPanel(String id, IModel<String> headingModel, Heading.Level headingLevel)
    {
        super(id, headingModel, headingLevel);
    }

    public EditableActionPanel(String id, IModel<T> model, IModel<String> headingModel, Heading.Level headingLevel)
    {
